    ...
    <div className="relative min-h-screen overflow-hidden bg-[#050816]">
      ...
      <div className="relative z-10 flex min-h-screen">
        ...
        <div className="flex w-full lg:w-[45%] items-center justify-center px-8">
            ...
            <div className="w-full max-w-[560px] rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-3xl shadow-[0_0_50px_rgba(37,99,235,.15)] flex flex-col justify-start">         
